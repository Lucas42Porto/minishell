...
# PIPE TESTS
exec_test1 'cat test/prompt.txt | grep while | cat -e'
exec_test2 'cat test/prompt.txt | grep while | cat -e'
...
exec_test1 "exit 259 fefnje"
exec_test2 "exit 259 fefnje"
exec_test1 "exit fefnje 259"
exec_test2 "exit fefnje 259"
